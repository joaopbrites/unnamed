...
from .views import (
    ...
    UserListAdminView, UserRoleUpdateView,
)

urlpatterns = [
    path("register/", RegisterView.as_view(), name="register"),
    path("me/", MeView.as_view(), name="me"),
    path("users/", UserListAdminView.as_view(), name="user-list-admin"),
    path("users/<int:pk>/", UserRoleUpdateView.as_view(), name="user-role-update"),
